...
def test_linear_combination(implementation):
    ...
    if implementation == "python":
        ...
        taylor.MultivariateTaylorFunction.initialize_mtf(max_order=1, max_dimension=1, implementation="python")
...
def test_matrix_inversion(implementation):
    ...
    if implementation == "python":
        ...
        M = np.array([
            ...
            [taylor.MultivariateTaylorFunction.from_constant(0.0), taylor.MultivariateTaylorFunction.from_constant(1.0)]
        ], dtype=object)

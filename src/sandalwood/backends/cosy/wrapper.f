...
*
 ...
 10   CONTINUE
     ...
     *        NC(LMEM),NDIM(LDIM)
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER IDX_IN, IDX_WEIGHT, IC(1)
      DOUBLE PRECISION VAL
      PARAMETER(LMEM=140000000,LVAR=10000000,LDIM=1000)
      INTEGER NTYP(LVAR),NBEG(LVAR),NEND(LVAR),NMAX(LVAR),
     *        NC(LMEM),NDIM(LDIM)
...
C     sinh(x+iy) = sinh(x)cos(y) + i cosh(x)sin(y)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER INA, INC, IC_RE(8), IC_CD(1)
      PARAMETER(LEA=100000)
      COMMON /DACOM/ CDA(2*LEA),EPS,EPSMAC,IE1(LEA),IE2(LEA),
     *       IEO(LEA),IA1(0:1400000),IA2(0:1400000),NCFLT(LEA),
     *       IEW(40),IED(40),LEW,LEWI,IESP,NOMAX,NVMAX,NMMAX,NOCUT,
...
C     cosh(x+iy) = cosh(x)cos(y) + i sinh(x)sin(y)
     ...
     *       LFLT,NFLT
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER IIV, INA, INC, IVAR_DA, I_RE, I_IM, I_RE_RES, I_IM_RES
C
      PARAMETER(LMEM=140000000,LVAR=10000000,LDIM=1000)
      INTEGER NTYP(LVAR),NBEG(LVAR),NEND(LVAR),NMAX(LVAR),
     *        NC(LMEM),NDIM(LDIM)
...
C
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER IDX_A, IDX_RES, ICT(1), IC(1), I_CONST
      DOUBLE PRECISION VAL
      PARAMETER(LEA=100000)
      COMMON /DACOM/ CDA(2*LEA),EPS,EPSMAC,IE1(LEA),IE2(LEA),
     *       IEO(LEA),IA1(0:1400000),IA2(0:1400000),NCFLT(LEA),
...
C     ------------------------------------------------------------------
      ...
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      INTEGER N
      INTEGER IDX_A(N), IDX_B(N), IDX_RES(N)
      INTEGER K
      PARAMETER(LEA=100000)
      COMMON /DACOM/ CDA(2*LEA),EPS,EPSMAC,IE1(LEA),IE2(LEA),
     *       IEO(LEA),IA1(0:1400000),IA2(0:1400000),NCFLT(LEA),

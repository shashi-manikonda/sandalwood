...
*
*      -1->-9         STANDARD INTERACTIVE OUTPUT (DEFAULT: GUI)
*                     IF ANY OF PGP, GRW, AQT IS ACTIVATED,
*                     IT BECOMES THE STANDARD INTERACTIVE OUTPUT.
*
...
*
      IF(IUNIT.LE.-201.AND.IUNIT.GE.-210) THEN
         ...
         GOTO 110
  101    CALL GUIMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 110
  102    CALL GUIDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 110
  103    CALL GUIDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 110
  104    CALL GUITRI(CC(I),CC(I+1),CC(I+2))
         GOTO 110
  105    CALL GUIPLY(I,NINT(CC(I)))
         GOTO 110
  106    IS = I
         DO 100 J=1,NLEN
  ...
  100    CONTINUE
         ...
         GOTO 110
  107    CALL GUICOL(CC(I))
         GOTO 110
  108    CALL GUIWID(CC(I))
         GOTO 110
  109    CALL GUISTL(NCI,NLEN,I)
  110    I = I+NLEN
...
*
      ELSEIF(IUNIT.EQ.-10) THEN
         ...
         GOTO 210
  201    CALL POSMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 210
  202    CALL POSDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 210
  203    CALL POSDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 210
  204    CALL POSTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 210
  205    CALL POSPLY(I,NINT(CC(I)))
         GOTO 210
  206    IS = I
         DO 200 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  200    CONTINUE
         ...
         GOTO 210
  207    CALL POSCOL(CC(I))
         GOTO 210
  208    CALL POSWID(CC(I))
         GOTO 210
...
*
      ELSEIF(IUNIT.EQ.-12) THEN
         ...
         GOTO 310
  301    CALL PDFMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 310
  302    CALL PDFDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 310
  303    CALL PDFDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 310
  304    CALL PDFTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 310
  305    CALL PDFPLY(I,NINT(CC(I)))
         GOTO 310
  306    IS = I
         DO 300 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  300    CONTINUE
         ...
         GOTO 310
  307    CALL PDFCOL(CC(I))
         GOTO 310
  308    CALL PDFWID(CC(I))
         GOTO 310
...
*
      ELSEIF(IUNIT.EQ.-13) THEN
         ...
         GOTO 410
  401    CALL SVGMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 410
  402    CALL SVGDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 410
  403    CALL SVGDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 410
  404    CALL SVGTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 410
  405    CALL SVGPLY(I,NINT(CC(I)))
         GOTO 410
  406    IS = I
         DO 400 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  400    CONTINUE
         ...
         GOTO 410
  407    CALL SVGCOL(CC(I))
         GOTO 410
  408    CALL SVGWID(CC(I))
         GOTO 410
  409    CALL GENSTL(NCI,NLEN,I)
  410    I = I+NLEN
         CALL SVGEND(NARI)
         RETURN
*
      ELSEIF((IUNIT.EQ.-14).OR.(IUNIT.EQ.-15)) THEN
         ...
         GOTO 510
  501    CALL STLMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 510
  502    CALL STLDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 510
  503    CALL STLDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 510
  504    CALL STLTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 510
  505    CALL STLPLY(I,NINT(CC(I)))
         GOTO 510
  506    IS = I
         DO 500 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  500    CONTINUE
         ...
         GOTO 510
  507    CALL STLCOL(CC(I))
         GOTO 510
  508    CALL STLWID(CC(I))
         GOTO 510
...
*
      ELSEIF(IUNIT.EQ.-11) THEN
         ...
         GOTO 610
  601    CALL ASCMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 610
  602    CALL ASCDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 610
  603    CALL ASCDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 610
  604    CALL ASCTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 610
  605    CALL ASCPLY(I,NINT(CC(I)))
         GOTO 610
  606    IS = I
         DO 600 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  600    CONTINUE
         ...
         GOTO 610
  607    CALL ASCCOL(CC(I))
         GOTO 610
  608    CALL ASCWID(CC(I))
         GOTO 610
  609    CALL ASCSTL(NCI,NLEN,I)
  610    I = I+NLEN
         CALL ASCEND
         RETURN
*
      ELSEIF(IUNIT.GT.0) THEN
         ...
         GOTO 710
  701    CALL TTYMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 710
  702    CALL TTYDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 710
  703    CALL TTYDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 710
  704    CALL TTYTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 710
  705    CALL TTYPLY(I,NINT(CC(I)))
         GOTO 710
  706    IS = I
         DO 700 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  700    CONTINUE
         ...
         GOTO 710
  707    CALL TTYCOL(CC(I))
         GOTO 710
  708    CALL TTYWID(CC(I))
         GOTO 710
  ...
  710    I = I+NLEN
         ...
         RETURN
*
      ELSEIF((IUNIT.LE.-101.AND.IUNIT.GE.-110).OR.
     *      (IUNIT.EQ.-20).OR.(IUNIT.EQ.-22)) THEN
         ...
         GOTO 810
  801    CALL PGPMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 810
  802    CALL PGPDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 810
  803    CALL PGPDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 810
  804    CALL PGPTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 810
  805    CALL PGPPLY(I,NINT(CC(I)))
         GOTO 810
  806    IS = I
         DO 800 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  800    CONTINUE
         ...
         GOTO 810
  807    CALL PGPCOL(CC(I))
         GOTO 810
  808    CALL PGPWID(CC(I))
         GOTO 810
...
*
      ELSEIF(IUNIT.LE.-111.AND.IUNIT.GE.-120) THEN
         ...
         GOTO 910
  901    CALL GRWMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 910
  902    CALL GRWDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 910
  903    CALL GRWDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 910
  904    CALL GRWTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 910
  905    CALL GRWPLY(I,NINT(CC(I)))
         GOTO 910
  906    IS = I
         DO 900 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
  ...
  900    CONTINUE
         ...
         GOTO 910
  907    CALL GRWCOL(CC(I))
         GOTO 910
  908    CALL GRWWID(CC(I))
         GOTO 910
  909    CALL GENSTL(NCI,NLEN,I)
  910    I = I+NLEN
         CALL GRWEND(NARI)
         RETURN
*
      ELSEIF(IUNIT.LE.-121.AND.IUNIT.GE.-130) THEN
         ...
         GOTO 1010
 1001    CALL AQTMOV(CC(I),CC(I+1),CC(I+2))
         GOTO 1010
 1002    CALL AQTDRA(CC(I),CC(I+1),CC(I+2))
         GOTO 1010
 1003    CALL AQTDOT(CC(I),CC(I+1),CC(I+2))
         GOTO 1010
 1004    CALL AQTTRI(CC(I),CC(I+1),CC(I+2))
         GOTO 1010
 1005    CALL AQTPLY(I,NINT(CC(I)))
         GOTO 1010
 1006    IS = I
         DO 1000 J=1,NLEN
         STR(J:J) = CHAR(NINT(CC(IS)))
 ...
 1000    CONTINUE
         ...
         GOTO 1010
 1007    CALL AQTCOL(CC(I))
         GOTO 1010
 1008    CALL AQTWID(CC(I))
         GOTO 1010
...
*     AND ALSO FOR FOXPRI FOR THE SAKE OF CALLING GUIPRI,
...
*-----GRAPH CONTEXT ---------------------------------------------------------
      ...
      INTEGER LGM,LWR,LDOTW,LDOTC,NPLY,IPLY
      COMMON /GRAPHCOM/ XC,XP,ACC,ACW,EPSXYZ,EPSCOL,
     *       LGM,LWR,LDOTW,LDOTC,NPLY,IPLY
*----------------------------------------------------------------------------
...
*     CONTRIBUTED BY EREMEY VALETOV   (2020)                                  *
*     MODIFIED BY K. MAKINO (2021)                                            *
*                                                                             *
*******************************************************************************
...
*        OUTPUT NUMBERS TO GUI USING HEXADECIMAL VALUES, Z8.8 FOR REAL
         WRITE(6,'(A,I0,A,$)')    'E',NELE,';'
         IF(IZOOM.EQ.0) THEN
            WRITE(6,'(A,4Z8.8,A,$)') 'B',0.0,1.0,0.0,1.0,';'
         ELSE
            CALL PROJEC(BD3(1,1),BD3(2,1),BD3(3,1),X1,Y1)
            CALL PROJEC(BD3(1,2),BD3(2,2),BD3(3,2),X2,Y2)
            WRITE(6,'(A,4Z8.8,A,$)') 'B',REAL(X1),REAL(X2),
     *                                   REAL(Y1),REAL(Y2),';'
         ENDIF
         CALL GENBEG
      ELSE
...
*
      IF(LGUI.EQ.1) THEN
         CALL PROJEC(XXX,YYY,ZZZ,X,Y)
         WRITE(6,'(A,2Z8.8,A,$)') 'M',REAL(X),REAL(Y),';'
         CALL GENMOV(XXX,YYY,ZZZ)
      ELSE
...
*
      IF(LGUI.EQ.1) THEN
         CALL PROJEC(XXX,YYY,ZZZ,X,Y)
         WRITE(6,'(A,2Z8.8,A,$)') 'D',REAL(X),REAL(Y),';'
         CALL GENDRA(XXX,YYY,ZZZ)
      ELSE
         CALL TTYDRA(XXX,YYY,ZZZ)
      ENDIF
...
*
      IF(LGUI.EQ.1) THEN
         CALL PROJEC(XXX,YYY,ZZZ,X,Y)
         WRITE(6,'(A,2Z8.8,A,$)') 'X',REAL(X),REAL(Y),';'
         CALL GENDOT(XXX,YYY,ZZZ)
      ELSE
...
*
      IF(LGUI.EQ.1) THEN
         CALL PROJEC(XXX,YYY,ZZZ,X,Y)
         WRITE(6,'(A,2Z8.8,A,$)') 'T',REAL(X),REAL(Y),';'
         CALL GENTRI(XXX,YYY,ZZZ)
      ELSE
...
*
      IF(LCR) THEN
*        ND=7 AS ALPHA FOR RGBA IS AVAILABLE.
         ND = 7
         DO 10 K=1,4
         OACC(K) = ACC(K)
 10      CONTINUE
...
*      * VARYING COLOR CURVE *
         IF(LCR) THEN
            CALL PROJPNT(NP1)
            WRITE(6,'(A,Z3.3,$)') 'P2CG',NP1
            DO 20 I=0,NP1
            WRITE(6,'(6Z8.8,$)') (REAL(PNT(J,I)),J=1,2),
     *                           (REAL(PNT(J,I)),J=4,7)
 20         CONTINUE
            WRITE(6,'(A,$)') ';'
*
*      * SOLID COLOR CURVE *
         ELSE
            CALL GUIMOV(PNT(1,0),PNT(2,0),PNT(3,0))
            DO 30 I=1,NP1
            CALL GUIDRA(PNT(1,I),PNT(2,I),PNT(3,I))
 30         CONTINUE
         ENDIF
*
*     SURFACE
...
*
            DO 40 I1=0,NP1
            IF(LCR) THEN
               WRITE(6,'(6Z8.8,$)') (REAL(PNT(J,I1)),J=1,2),
     *                              (REAL(PNT(J,I1)),J=4,7)
            ELSE
               WRITE(6,'(6Z8.8,$)') (REAL(PNT(J,I1)),J=1,2),
     *                              (REAL(ACC(J)),J=1,4)
...
*
 ...
 52         CLR(J-3) = (PNTO(J,I)+PNT(J,I))*0.5D0
            IF(LCR) CALL GUICOL(CLR)
            CALL GUIMOV(PNTO(1,I),PNTO(2,I),PNTO(3,I))
            CALL GUIDRA(PNT(1,I),PNT(2,I),PNT(3,I))
 60         CONTINUE
*
            CALL GUIMOV(PNT(1,0),PNT(2,0),PNT(3,0))
 ...
 80         CONTINUE
      ...
      ENDIF
*
      IF(LCR) CALL GUICOL(OACC)
      CALL GENPLY(IA)
      RETURN
*
 90   CALL GENPLY(IA)
      CALL PROJEC(XC(1),XC(2),XC(3),X,Y)
      WRITE(6,'(A,2Z8.8,A,$)') 'P0',REAL(X),REAL(Y),';'
      RETURN
*
      END
*
...
*     **********************
*
*     NOTE: THE GUI DRIVER SUPPORTS ALPHA OF RGBA FOR OPACITY. SEE ALSO GRCOLR.
*
*-----GUI -------------------------------------------------------------------
      PARAMETER(LGV=100,LGW=10)
      INTEGER LGUI,NGVAR(LGW,2),IGVAR(LGW,LGV,2)
...
*
 ...
 10      CONTINUE
         WRITE(6,'(A,4Z2.2,A,$)') 'R',(ICLR(J),J=1,4),';'
         CALL GENCOL(CLR)
      ELSE
         CALL TTYCOL(CLR)
      ENDIF
...
*
         IF(ID.EQ.9) WRITE(6,'(A,I1,A,$)') 'Y',LWR,';'
      ENDIF
*
      RETURN
      END
...
*
      IF(LGUI.EQ.1) THEN
         IF(NARI.GT.0) THEN
            WRITE(6,'(A,4Z2.2,A,$)') 'R',0,0,0,255,';'
            WRITE(6,'(A,2Z8.8,A,$)') 'M',0.007,0.010,';'
            WRITE(CNARI,'(I10)') NARI
            WRITE(6,'(A,$)') 'S'//
     *      '$$$ WARNING, GRPOLY ARITHMETIC FAILURES: '//CNARI//';'
         ENDIF
*
*        CAUTION: THE LAST GUI OUTPUT HAS TO BE 'F'.
*
         WRITE(6,'(A)') 'F'
         CALL FLUSH(6)
         CALL GENEND
...
*
      ...
      WRITE(4,'(A)') '%%Pages: 1'
      WRITE(4,'(A)') '%%Page: 1 1'
      WRITE(4,'(A)') '/sn {gsave 1 1.5 scale stroke grestore'
     *   //' newpath} bind def'
...
*     **********************
*
*     NOTE: THE POSTSCRIPT DRIVER DOES NOT SUPPORT ALPHA OF RGBA FOR OPACITY.
*
*-----GRAPH CONTEXT ---------------------------------------------------------
      DOUBLE PRECISION XC(3),XP(3),ACC(4),ACW,EPSXYZ,EPSCOL
      INTEGER LGM,LWR,LDOTW,LDOTC,NPLY,IPLY
...
*
      IF(LAUTO) THEN
         ...
         ERP = ERTOL*1.D2
         IF(EPSXYZ.EQ.0.D0.AND.EPSCOL.EQ.0.D0) THEN
            WRITE(STA(3),'(A,2(F4.1,A))') STRE,ERP,'%,',ERP,'%'
         ELSEIF(EPSXYZ.EQ.0.D0) THEN
            WRITE(STA(3),'(A,F4.1,A,E13.5)') STRE,ERP,'%,',EPSCOL
         ELSEIF(EPSCOL.EQ.0.D0) THEN
            WRITE(STA(3),'(A,E13.5,A,F4.1,A)') STRE,EPSXYZ,',',ERP,'%'
         ELSE
            WRITE(STA(3),'(2(A,E13.5))') STRE,EPSXYZ,',',EPSCOL
         ENDIF
      ENDIF
*
*   * POS
...
*
*        THIS MEMORY SIZE ERROR DOES NOT HAPPEN. CHECKING TO BE SURE.
         IF(NCV+1.GT.MLEN) CALL FOXERV('PDFSH')
*
         CALL PDFSHB(2,NCV+1)
         DO 240 I=0,NCV
         DO 220 J=4,ND
...
*     **********************
*
*     NOTE: THE PDF DRIVER DOES NOT SUPPORT ALPHA OF RGBA FOR OPACITY.
*
*-----GRAPH CONTEXT ---------------------------------------------------------
      DOUBLE PRECISION XC(3),XP(3),ACC(4),ACW,EPSXYZ,EPSCOL
      INTEGER LGM,LWR,LDOTW,LDOTC,NPLY,IPLY
...
*
     ...
     *               'font-size: 30px; }'
      WRITE(4,'(A)') '</style>'
      WRITE(4,'(A)') '<title>COSY INFINITY SVG Graphics (pic'//NUMBER//
     *               '.svg)</title>'
*
      CALL GENBEG
*
...
*     **********************
*
*     NOTE: THE SVG DRIVER SUPPORTS ALPHA OF RGBA FOR OPACITY. SEE ALSO GRCOLR.
*
*-----GRAPH CONTEXT ---------------------------------------------------------
      DOUBLE PRECISION XC(3),XP(3),ACC(4),ACW,EPSXYZ,EPSCOL
      INTEGER LGM,LWR,LDOTW,LDOTC,NPLY,IPLY
...
*     **********************
*
*     NOTE: THE PGPLOT DRIVER DOES NOT SUPPORT ALPHA OF RGBA FOR OPACITY.
*
      DOUBLE PRECISION CLR(4)
*
...
*     **********************
*
*     NOTE: THE GRWIN DRIVER DOES NOT SUPPORT ALPHA OF RGBA FOR OPACITY.
*
      DOUBLE PRECISION CLR(4)
      INTEGER ICLR(3)
*
...
*     BEFORE EACH DRAW UNLESS IT WAS IMMEDIATELY PRECEEDED BY ANOTHER DRAW.
      IF(LGM.NE.1) CALL AQTMOV(XC(1),XC(2),XC(3))
*
      CALL PROJEC(XXX,YYY,ZZZ,XX,YY)
      X = REAL(XX*AQTW)
      Y = REAL(YY*AQTH)
...
*     **********************
*
*     NOTE: THE CURRENT AQUATERM DRIVER DOES NOT SUPPORT ALPHA OF RGBA
*           FOR OPACITY.
*
      DOUBLE PRECISION CLR(4)
*

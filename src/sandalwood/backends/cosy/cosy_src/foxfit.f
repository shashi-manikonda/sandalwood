...
*
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
*
      PARAMETER (ND=20,ALPHAS=.9D0,BETAS=.45D0,GAMMAS=1.9D0)
...
*
      DO 110 J=1,NDIM
      PR(J)=(1.D0+ALPHAS)*PBAR(J)-ALPHAS*P(IHI,J)
      X(J) = PR(J)
 110  CONTINUE
*
      IEND = 0
...
*
      DO 210 J=1,NDIM
      PRR(J)=GAMMAS*PR(J)+(1.D0-GAMMAS)*PBAR(J)
      X(J) = PRR(J)
 210  CONTINUE
*
      IEND = 0
...
*
      DO 315 J=1,NDIM
      PRR(J) = BETAS*P(IHI,J)+(1.D0-BETAS)*PBAR(J)
      X(J)   = PRR(J)
 315  CONTINUE
*
      IEND = 0

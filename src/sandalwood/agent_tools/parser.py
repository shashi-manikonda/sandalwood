...
def expression_to_mtf(expression: str, dimension: int, max_order: int) -> MultivariateTaylorFunction:
    """
    ...
    var_dict = {f'x{i}': mtf.var(i, dimension=dimension) for i in range(1, dimension + 1)}
